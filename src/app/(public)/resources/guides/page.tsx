...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: getAlternates("/resources/guides"),
  };
}
                      ...
                      <article className="bg-bg-card border border-white/[0.06] rounded-xl overflow-hidden hover:border-brand-gold/30 transition-all duration-300 hover:shadow-lg hover:shadow-brand-gold/5">
                        <div className="flex flex-col md:flex-row">
                          ...
                          <div className="md:w-3/5 lg:w-2/3 p-6 lg:p-10 flex flex-col justify-center">
                            ...
                            <h2 className="text-2xl lg:text-3xl font-heading font-bold text-white group-hover:text-brand-gold transition-colors mb-4"><SafeHtml html={guide.title} /></h2>
                            <p className="text-white/50 leading-relaxed mb-6"><SafeHtml html={guide.description} /></p>
