...
export const metadata: Metadata = {
  title: "Sign Installation Tips — Wholesale Channel Letter Mounting & Best Practices | Sunlite Signs",
  description:
    "Practical wholesale channel letter installation guidance for sign shop professionals and trade buyers. Covers site preparation, mounting methods, electrical requirements, weather sealing, and quality assurance.",
  keywords: [
    "wholesale channel letter installation",
    "sign installation tips trade",
    "how to install channel letters",
    "channel letter mounting guide wholesale",
    "sign installation best practices",
    "raceway installation trade",
    "channel letter wiring",
  ],
  openGraph: {
    title: "Sign Installation Tips — Wholesale Channel Letter Mounting & Best Practices | Sunlite Signs",
    description:
      "Practical wholesale channel letter installation guidance for trade professionals covering mounting, electrical, weather sealing, and quality assurance.",
    url: "https://sunlitesigns.com/resources/guides/sign-installation-tips",
  },
};
          ...
          <div className="max-w-3xl">
            ...
            <AnimatedSection>
              <div className="mb-16">
                ...
                <PlaceholderImage
                  label="Installation crew performing site survey with measuring tools"
            ...
            <AnimatedSection>
              <div className="mb-16">
                ...
                <div className="bg-brand-gold/5 border border-brand-gold/20 rounded-xl p-6 my-8">
                  ...
                  {[
                    {
                      ...
                      fix: "Always verify the mounting surface, electrical feed, and access conditions before installation day.",
                    },
                    {
                      mistake: "Using wrong fasteners for the wall type",
                      fix: "Match fasteners to the specific wall material. Toggle bolts for hollow walls, expansion anchors for concrete, lag bolts for wood framing.",
                    },
                    {
                      mistake: "Inadequate sealing of wall penetrations",
                      fix: "Use exterior-rated silicone on every penetration. Water damage from a poorly sealed sign installation is a costly callback.",
                    },
                    {
                      mistake: "Not testing illumination before final mounting",
                      fix: "Bench-test all letters on the ground before lifting them into position. It is much easier to troubleshoot at ground level.",
                    },
                    {
                      mistake: "Inconsistent standoff lengths for halo-lit letters",
                      fix: "Measure and verify every standoff before installation. Even small inconsistencies create visible unevenness in the halo effect.",
                    },
                  ].map((item, i) => (
                    <li
                      key={i}
